        ...
        <article className="bg-[#181823] mb-6 2xl:w-[700px]">
          ...
          <div className="px-3 3xl:px-6 py-5 3xl:py-8">
            ...
            <p className="text-[#8491A0] 3xl:text-lg mb-3">
              Challenge: Use an API about the global weather, and show weather
              results according to the user's location, in addition to a search
              input, dark mode and changing the icon and image background in
              relation to the indicated weather.
            </p>
        ...
        <article className="bg-[#181823] mb-6 2xl:w-[700px]">
          ...
          <div className="px-3 3xl:px-6 py-5 3xl:py-8">
            ...
            <p className="text-[#8491A0] 3xl:text-lg mb-3">
              ...
              input by name, select by typee and color display according to the
              pokemon type, as well as routes for the details of each pokemon.
            </p>
            <div className="flex justify-end">
              <button className="text-white 3xl:text-lg border-[#5221E6] border-b mx-3 py-1 hover:bg-[#5221E6] hover:mx-0 hover:px-3 hover:rounded-full transition-all">
                <a
      ...
      <div className="2xl:mx-auto 3xl:pr-[2%]">
        <article className="bg-[#181823] mb-6 2xl:w-[700px]">
          ...
          <div className="px-3 3xl:px-6 py-5 3xl:py-8">
            ...
            <p className="text-[#8491A0] 3xl:text-lg mb-3">
              Challenge: Make the functionalities, add to cart, uncheck and buy.
              and persistence in local storage of added elements.
            </p>
            <div className="flex justify-end">
              <button className="text-white 3xl:text-lg border-[#5221E6] border-b mx-3 py-1 hover:bg-[#5221E6] hover:mx-0 hover:px-3 hover:rounded-full transition-all">
                <a
